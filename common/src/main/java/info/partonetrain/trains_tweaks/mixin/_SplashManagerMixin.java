    ...
    public List<String> trains_tweaks$prepare(List<String> original){
        ...
        if(original.contains("Vanilla!")){   //almost certainly using default splashes.txt
            ...
            if(Minecraft.getInstance().getLanguageManager().getSelected().equals("en_us")) {
                ...
                original.add(RANDOM.nextIntBetweenInclusive(0, original.size() - 1), new String(new byte[]{0x4d, 0x61, 0x6b, 0x65, 0x20, 0x73, 0x75, 0x72, 0x65, 0x20, 0x79, 0x6f, 0x75, 0x27, 0x72, 0x65, 0x20, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x65, 0x64, 0x20, 0x74, 0x6f, 0x20, 0x76, 0x6f, 0x74, 0x65, 0x20, 0x69, 0x6e, 0x20, 0x4e, 0x6f, 0x76, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x21}, StandardCharsets.UTF_8));
                original.add(RANDOM.nextIntBetweenInclusive(0, original.size() - 1), new String(new byte[]{0x44, 0x6f, 0x6e, 0x27, 0x74, 0x20, 0x6c, 0x65, 0x74, 0x20, 0x74, 0x68, 0x65, 0x6d, 0x20, 0x74, 0x61, 0x6b, 0x65, 0x20, 0x79, 0x6f, 0x75, 0x72, 0x20, 0x6a, 0x6f, 0x79, 0x20, 0x66, 0x72, 0x6f, 0x6d, 0x20, 0x79, 0x6f, 0x75, 0x21}, StandardCharsets.UTF_8));
            }
        }
