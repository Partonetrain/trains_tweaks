...
public class AllFeatures {
    ...
    public static final ModFeature LOOT_FEATURE = new LootFeature();
    ...
    public static final ModFeature QUASI_FEATURE = new QuasiFeature();
