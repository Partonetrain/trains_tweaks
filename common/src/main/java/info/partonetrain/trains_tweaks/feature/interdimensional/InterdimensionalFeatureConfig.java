...
public class InterdimensionalFeatureConfig {
    ...
    public static ModConfigSpec.BooleanValue END_PORTAL_BLOCK_TAG;
    public static ModConfigSpec.BooleanValue END_PORTAL_DIMENSIONS_TAG;
    ...
    public static void registerConfig(ModConfigSpec.Builder builder) {
        ...
        NETHER_PORTAL_BLOCK_TAG = builder.comment("Whether or not the tags " + Constants.NETHER_PORTAL_FRAME_TAG.location() + " and " + Constants.NOT_NETHER_PORTAL_FRAME_TAG.location() + " function")
        ...
        NETHER_PORTAL_DIMENSIONS_TAG = builder.comment("If set to true, any dimension in the dimension type tag " + Constants.SUPPORTS_NETHER_PORTALS_TAG.location() + " will be able to have Nether Portals constructed in it")
                .comment("Nether Portals in the Nether will still return you to the Overworld. Allowing creation of Nether Portals in non-Overworld dimensions has the potential for sequence breaks and other weirdness and isn't recommended")
