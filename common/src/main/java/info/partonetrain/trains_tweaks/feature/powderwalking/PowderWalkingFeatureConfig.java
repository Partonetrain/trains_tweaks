...
public class PowderWalkingFeatureConfig {
    ...
    public static void registerConfig(ModConfigSpec.Builder builder) {
        ...
        ENABLED = builder.comment("Whether or not to enable the functionality of the " + Constants.POWDER_WALKER_ARMOR_TAG.location() + ", " + Constants.POWDER_WALKER_ARMOR_DENIED_TAG.location() + ", and " + Constants.POWDER_WALKER_ITEM_TAG.location() + " item tags")
